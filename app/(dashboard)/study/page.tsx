    ...
    <div className="mx-auto max-w-7xl px-4 pb-16 pt-6 space-y-6">
      ...
      <section className="rounded-3xl border border-violet-400/15 bg-[rgba(12,15,27,0.82)] p-6 shadow-[0_20px_80px_rgba(0,0,0,0.28)]">
        <p className="mb-2 inline-flex items-center gap-2 rounded-full border border-violet-300/25 bg-violet-400/10 px-3 py-1 text-xs font-medium text-violet-100">
          <Brain className="h-3.5 w-3.5" /> AI Study Intelligence
        </p>
        <h2 className="text-3xl font-semibold tracking-tight text-white">Study Planner</h2>
        <p className="mt-2 max-w-2xl text-sm text-slate-300">
          AI-ranked priorities, smart reminders, a generated weekly schedule, and grade-impact analysis — all in one place.
        </p>
      </section>
